...
class ProviderSpec:
    ...
    display_name: str = ""  # shown in `amberclaw status`
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # Ollama: detected when name is "ollama"
    ProviderSpec(
        name="ollama",
        keywords=("ollama",),
    ...
    # Amazon Bedrock: needs "bedrock/" prefix.
    ProviderSpec(
        name="bedrock",
        keywords=("bedrock",),
    ...
    # xAI: Grok models, needs "xai/" prefix.
    ProviderSpec(
        name="xai",
        keywords=("grok", "xai"),
        env_key="XAI_API_KEY",
    ...
    # Cohere: Command models, needs "cohere/" prefix.
    ProviderSpec(
        name="cohere",
    ...
    # NVIDIA NIM: needs "nvidia_nim/" prefix.
    ProviderSpec(
        name="nvidia_nim",
        keywords=("nvidia", "nim"),
