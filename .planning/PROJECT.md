...
- ✓ **Memory & RAG System**: Persistent Mem0 v1.0+ integration with ChromaDB backend and knowledge graphs.

### Active

- [ ] **AmberClaw Doctor**: Implementation of system health check CLI command.
- [ ] **Async Data Operations**: Offloading Pandas I/O to background threads.
- [ ] **Parallel Tool Execution**: Run independent tool calls in `asyncio.TaskGroup`.
- [ ] **Unified Messaging Bus**: Enhanced routing for multi-channel support.
- [ ] **MCP Integration**: Support for external MCP servers.
- [ ] **LLM Upgrade (v1.1)**: Fix models, add providers (xAI, etc.), routing, cost tracking.
- [ ] **Protocols & Tools (v1.2)**: MCP 2026, A2A, ClawHub, Security Scanning.
...
---
*Last updated: 2026-04-27 for Milestone 9*
