...
- **Memory**: Mem0 v1.0+ for persistent, multi-scope conversational memory and fact extraction.
- **RAG**: Persistent vector store (ChromaDB/LanceDB) with hybrid retrieval and reranking.
- **Knowledge Graph**: Temporal knowledge graph for structured relationship tracking.
