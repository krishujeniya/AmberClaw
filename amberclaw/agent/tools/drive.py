        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                ...
                if os.path.exists(creds_json):
                    ...
                    raise ConnectionError(\"Google Drive credentials not found. Please configure tools.drive.credentials_json\")
...
class DriveUploadInput(BaseModel):
    ...
    folder_id: str = Field(\"root\", description=\"ID of the destination folder in Google Drive (defaults to 'root').\")
