...
from amberclaw.config.schema import DingTalkConfig
...
class AmberClawDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the AmberClaw channel.
    """
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = AmberClawDingTalkHandler(self)
    ...
    async def _send_markdown_text(self, token: str, chat_id: str, content: str) -> bool:
        return await self._send_batch_message(
            ...
            chat_id,
            "sampleMarkdown",
            {"text": content, "title": "AmberClaw Reply"},
        )
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by AmberClawDingTalkHandler).
