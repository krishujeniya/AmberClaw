...
from amberclaw.data.templates import (
...
from amberclaw.data.parsers.parsers import PythonOutputParser
...
class FeatureEngineeringAgent(BaseAgent):
    ...
    from amberclaw.data.agents import FeatureEngineeringAgent
...
def make_feature_engineering_agent(
    ...
    import pandas as pd
    from langchain_openai import ChatOpenAI
    from amberclaw.data.agents import feature_engineering_agent
