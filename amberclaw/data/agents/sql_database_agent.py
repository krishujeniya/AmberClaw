...
from amberclaw.data.parsers.parsers import SQLOutputParser
...
from amberclaw.data.tools.sql import get_database_metadata
...
def make_sql_database_agent(
    ...
    --------
    ```python
    from amberclaw.data.agents import make_sql_database_agent
    import sqlalchemy as sql
    from langchain_openai import ChatOpenAI
