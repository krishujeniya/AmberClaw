...
from amberclaw.data.templates import BaseAgent
from amberclaw.data.agents import SQLDatabaseAgent, DataVisualizationAgent
from amberclaw.data.utils.plotly import plotly_from_dict
from amberclaw.data.utils.regex import (
...
class SQLDataAnalyst(BaseAgent):
    ...
    async def ainvoke_agent(
        ...
        **kwargs:
        ...
        from amberclaw.data.multiagents import SQLDataAnalyst
        from amberclaw.data.agents import SQLDatabaseAgent, DataVisualizationAgent
