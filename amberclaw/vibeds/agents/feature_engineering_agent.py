...
from amberclaw.vibeds.templates import (
...
from amberclaw.vibeds.parsers.parsers import PythonOutputParser
from amberclaw.vibeds.utils.regex import (
...
from amberclaw.vibeds.tools.dataframe import get_dataframe_summary
from amberclaw.vibeds.utils.logging import log_ai_function, log_ai_error
from amberclaw.vibeds.utils.sandbox import run_code_sandboxed_subprocess
from amberclaw.vibeds.utils.messages import get_last_user_message_content
...
class FeatureEngineeringAgent(BaseAgent):
    ...
    from amberclaw.vibeds.agents import FeatureEngineeringAgent
...
def make_feature_engineering_agent(
    ...
    import pandas as pd
    from langchain_openai import ChatOpenAI
    from amberclaw.vibeds.agents import feature_engineering_agent
