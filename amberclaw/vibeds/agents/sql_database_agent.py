...
from amberclaw.vibeds.parsers.parsers import SQLOutputParser
...
from amberclaw.vibeds.tools.sql import get_database_metadata
...
def make_sql_database_agent(
    ...
    --------
    ```python
    from amberclaw.vibeds.agents import make_sql_database_agent
    import sqlalchemy as sql
    from langchain_openai import ChatOpenAI
