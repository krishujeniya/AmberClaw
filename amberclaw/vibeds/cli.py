...
app = typer.Typer(
    name="vibeds",
    help="🚀 VibeDS: Your AI-powered Data Science Team in the Terminal.",
...
def callback():
    """
    VibeDS - Intent-based Data Science CLI.
...
def clean(
    ...
    """
    console.print(Panel(f"🧼 [bold blue]Cleaning Agent[/bold blue] started for: [yellow]{file_path}[/yellow]", title="VibeDS"))
...
def viz(
    ...
    """
    console.print(Panel(f"📈 [bold magenta]Visualization Agent[/bold magenta] analyzing: [yellow]{file_path}[/yellow]", title="VibeDS"))
