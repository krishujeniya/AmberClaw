...
from amberclaw.vibeds.templates import BaseAgent
from amberclaw.vibeds.agents import SQLDatabaseAgent, DataVisualizationAgent
...
class SQLDataAnalyst(BaseAgent):
    ...
    async def ainvoke_agent(
        ...
        **kwargs:
        ...
        from amberclaw.vibeds.multiagents import SQLDataAnalyst
        from amberclaw.vibeds.agents import SQLDatabaseAgent, DataVisualizationAgent
