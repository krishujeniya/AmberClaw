...
def mock_prompt_session():
    ...
    with patch("amberclaw.cli.commands._PROMPT_SESSION", mock_session), \
...
def test_init_prompt_session_creates_session():
    ...
    with patch("amberclaw.cli.commands.PromptSession") as MockSession, \
         patch("amberclaw.cli.commands.FileHistory") as MockHistory, \
